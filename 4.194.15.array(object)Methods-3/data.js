...
// function findTruthValue(array) {
//  return   array.sort((a,b)=>b.name-a.name?1:-1)
    
// }
// console.log(findTruthValue(countries_data));

///// area görə ilk 10 ölkə
// function firstArea(array) {
//   let result=array.sort((a,b)=>b.area-a.area).slice(0,10)
//   return result
// }
// console.log(firstArea(countries_data));
...
// function findCountries(array) {
//  return array.map((item)=>`${item.capital},${item.name}`)

// }
// console.log(findCountries(countries_data));

////////dünya əhalisinin sayı
// function popilation(array) {
//     return 
// }